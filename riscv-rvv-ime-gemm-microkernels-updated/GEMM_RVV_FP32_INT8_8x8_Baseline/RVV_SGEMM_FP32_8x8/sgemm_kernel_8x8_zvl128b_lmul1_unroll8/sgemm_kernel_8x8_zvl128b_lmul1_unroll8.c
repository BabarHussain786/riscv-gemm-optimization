...
*/
/*
 * Kernel dataflow summary: sgemm_kernel_8x8_zvl128b_lmul1_unroll8
...
int sgemm_kernel_8x8_zvl128b_lmul1_unroll8(BLASLONG M, BLASLONG N, BLASLONG K, FLOAT alpha, FLOAT *A, FLOAT *B, FLOAT *C, BLASLONG ldc)
{
    BLASLONG gvl = 0;
    BLASLONG m_top = 0;
    BLASLONG n_top = 0;
