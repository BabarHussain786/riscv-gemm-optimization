...
/*
RVV FP KERNEL
Variant: sgemm_kernel_8x8_zvl256b_lmul1_unroll1
Settings:
 LMUL=1 (m1)
 M=8
 N=8
 ...
 Kernel Name: sgemm_kernel_8x8_zvl256b_lmul1_unroll1
*/
/*
 * Kernel dataflow summary: sgemm_kernel_8x8_zvl256b_lmul1_unroll1
...
int sgemm_kernel_8x8_zvl256b_lmul1_unroll1(BLASLONG M, BLASLONG N, BLASLONG K, FLOAT alpha, FLOAT *A, FLOAT *B, FLOAT *C, BLASLONG ldc)
{
    BLASLONG gvl = 0;
    BLASLONG m_top = 0;
    BLASLONG n_top = 0;
