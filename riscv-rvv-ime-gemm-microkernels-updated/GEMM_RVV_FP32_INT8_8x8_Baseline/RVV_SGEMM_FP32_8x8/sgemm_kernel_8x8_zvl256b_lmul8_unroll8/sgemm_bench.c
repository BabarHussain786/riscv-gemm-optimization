...
/* Kernel declaration */
int sgemm_kernel_8x8_zvl256b_lmul8_unroll8(
...
int main(int argc, char **argv) {
    ...
    sgemm_kernel_8x8_zvl256b_lmul8_unroll8(M, N, K, 1.0f, A, B, C, M);

    /* Timed run */
    double t0 = now_sec();

    int rc = sgemm_kernel_8x8_zvl256b_lmul8_unroll8(M, N, K, 1.0f, A, B, C, M);
