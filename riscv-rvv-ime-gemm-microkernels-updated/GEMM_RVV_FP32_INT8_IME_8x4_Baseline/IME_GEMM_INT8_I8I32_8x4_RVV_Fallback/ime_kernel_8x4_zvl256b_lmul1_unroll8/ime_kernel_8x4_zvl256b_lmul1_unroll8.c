...
*/
/*
 * Kernel dataflow summary: ime_kernel_8x4_zvl256b_lmul1_unroll8
...
int igemm_kernel_8x4_zvl256b_lmul1_unroll8(
    ...
    const int8_t *A, const int8_t *B, int32_t *C, BLASLONG ldc)
{
    ...
    rc = igemm_kernel_8x4_zvl256b_lmul1_unroll8(M, N, K, alpha, A_rvv, B_rvv, C, ldc);
    free(A_rvv);
    free(B_rvv);
