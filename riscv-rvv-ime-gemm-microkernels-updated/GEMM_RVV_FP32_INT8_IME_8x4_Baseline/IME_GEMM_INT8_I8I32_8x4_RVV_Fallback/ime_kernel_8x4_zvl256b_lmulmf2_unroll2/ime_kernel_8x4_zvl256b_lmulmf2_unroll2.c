...
*/
/*
 * Kernel dataflow summary: ime_kernel_8x4_zvl256b_lmulmf2_unroll2
...
int igemm_kernel_8x4_zvl256b_lmulmf2_unroll2(
    ...
    const int8_t *A, const int8_t *B, int32_t *C, BLASLONG ldc)
{
    ...
    rc = igemm_kernel_8x4_zvl256b_lmulmf2_unroll2(M, N, K, alpha, A_rvv, B_rvv, C, ldc);
    free(A_rvv);
    free(B_rvv);
