...
#ifndef CNAME
#define CNAME igemm_kernel_8x4_zvl256b_lmulmf2_unroll8
#endif
...
int main(int argc, char **argv)
{
    ...
    int8_t *A = aligned_alloc(64, sizeA * sizeof(int8_t));
    int8_t *B = aligned_alloc(64, sizeB * sizeof(int8_t));
    int32_t *C = aligned_alloc(64, sizeC * sizeof(int32_t));
