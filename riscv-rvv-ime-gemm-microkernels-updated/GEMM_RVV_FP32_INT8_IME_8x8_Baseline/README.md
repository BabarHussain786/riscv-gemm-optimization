# FP32, INT8, and IME GEMM Baseline: 8x8 Tiles

This baseline groups the RVV and IME microkernels used to evaluate FP32 plus INT8 workloads with the 8x8 tile shape. It is one of the four top-level benchmark groups used by the K1 and K3 campaign scripts.

## Active Kernel Families

| Folder | Purpose | Variants |
|---|---|---:|
| `RVV_SGEMM_FP32_8x8/` | FP32 x FP32 -> FP32 RVV SGEMM kernels | 20 |
| `RVV_IGEMM_INT8_I8I32_8x8/` | INT8 x INT8 -> INT32 RVV IGEMM kernels | 28 |
...
```bash
cd ~/riscv-rvv-ime-gemm-microkernels/GEMM_RVV_FP32_INT8_IME_8x8_Baseline
