# FP64, INT8, and IME GEMM Baseline: 8x4 Tiles

This baseline groups the RVV and IME microkernels used to evaluate FP64 plus INT8 workloads with the 8x4 tile shape. It is one of the four top-level benchmark groups used by the K1 and K3 campaign scripts.
