# IME GEMM INT8 Microkernels With RVV Fallback: 8x8 Tiles

## Purpose

Self-contained SpacemiT IME INT8 GEMM microkernel family for 8x8 tiles. Each variant includes the IME implementation and a local RVV fallback source file, so the folder can be built independently from the standalone INT8 RVV kernel tree.
