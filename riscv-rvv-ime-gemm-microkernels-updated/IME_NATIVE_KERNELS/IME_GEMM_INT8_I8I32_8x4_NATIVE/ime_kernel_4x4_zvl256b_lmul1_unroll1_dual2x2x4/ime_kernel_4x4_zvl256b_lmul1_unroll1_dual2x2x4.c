 ...
 *
 * SpacemiT IME INT8 GEMM microkernel: ime_kernel_4x4_zvl256b_lmul1_unroll1_dual2x2x4
 *
 * Child-friendly view:
...
int ime_kernel_4x4_zvl256b_lmul1_unroll1_dual2x2x4(BLASLONG M, BLASLONG N, BLASLONG K,
              int32_t alpha, const int8_t *A, const int8_t *B,
              int32_t *C, BLASLONG ldc)
{
