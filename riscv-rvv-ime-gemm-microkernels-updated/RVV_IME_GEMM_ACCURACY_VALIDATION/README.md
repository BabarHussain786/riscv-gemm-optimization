...
```bash
INPUT_CLASSES="full_range_uniform" bash run_int8_ime_vs_rvv_accuracy.sh k1 1
INPUT_CLASSES="bounded_uniform full_range_uniform mixed_magnitude cancellation_stress" bash run_int8_ime_vs_rvv_accuracy.sh k1 1
```
